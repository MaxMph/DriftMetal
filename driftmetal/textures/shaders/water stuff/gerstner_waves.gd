...
@onready var water_scene = preload("res://textures/shaders/water stuff/gerstner_waves.tscn")
@onready var water_resource = preload("res://textures/shaders/water stuff/Water.tres")
var water_material
